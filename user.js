...
exports.makeClient = function(prefix, cb){
	internalmaker.make(function(internal){
...
exports.makeService = function(app, secureApp, host, secureHost, prefix, cb, userMadeCb){
